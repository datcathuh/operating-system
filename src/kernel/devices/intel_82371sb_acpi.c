...
static void
intel_82371sb_acpi_driver_description(struct pci_device_driver * /*driver*/,
...
static bool
intel_82371sb_acpi_driver_initialize(struct pci_device_driver * /*driver*/,
                                     struct pci_device * /*device*/) {
	return true;
}

static bool
intel_82371sb_acpi_driver_unload(struct pci_device_driver * /*driver*/,
                                 struct pci_device * /*device*/) {
	return true;
}
